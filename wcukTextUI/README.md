...
exports['wcukTextUI']:Open('[Key] Message', 'color', 'position')
...
To make the text bold: exports['wcukTextUI']:Open('<b>[Key] Message</b>', 'color', 'position')
To insert multiple lines/commands in a text UI: exports['wcukTextUI']:Open('[Key] Message 1<br>[Key] Message 2', 'color', 'position')
	...
	while true do
		...
		if inZone and not shown then
			...
			if locked and hasAuth then
				exports['wcukTextUI']:Open('[E] Locked', 'lightred', 'left')
			elseif not locked and hasAuth then
				exports['wcukTextUI']:Open('[E] Unlocked', 'lightgreen', 'left')
			elseif locked then
				exports['wcukTextUI']:Open('Locked', 'lightred', 'left')
			else
				exports['wcukTextUI']:Open('Unlocked', 'lightgreen', 'left')
			end
