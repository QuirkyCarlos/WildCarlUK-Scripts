local function openGarageBuyableVehicles(markerId)
    ESX.TriggerServerCallback('wcuk_job_creator:getGarageBuyableData', function(garageData)
        local elements = {}
        ...
        function(data, menu)
            ...
            function(data, menu)
                if(data.current.value == "yes") then
                    TriggerServerEvent('wcuk_job_creator:buyVehicleFromGarage', markerId, vehicleName)
                end
...
local function openGarageBuyableOwnedVehicles(markerId)
    ...
    ESX.TriggerServerCallback('wcuk_job_creator:getGarageOwnedVehicles', function(garageData)
        local elements = {}
        ...
        function(data, menu)
            ...
            ESX.Game.SpawnVehicle(vehicleName, coords, garageData.heading, function(vehicle)
                ...
                TriggerServerEvent('wcuk_job_creator:permanent_garage:vehicleIdSpawned', vehicleId, VehToNet(vehicle))
            end)
    ...
    function(data, menu)
        ...
        elseif(action == "deposit") then
            ...
            if(DoesEntityExist(vehicle)) then
                ...
                ESX.TriggerServerCallback('wcuk_job_creator:permanent_garage:updateVehicleProps', function(isSuccessful) 
