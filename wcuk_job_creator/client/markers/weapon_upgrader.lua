local function openComponents(markerId, weaponName)
    ESX.TriggerServerCallback('wcuk_job_creator:openComponents', function(components) 
        ...
        function(data, menu)
            ...
            TriggerServerEvent('wcuk_job_creator:buyWeaponComponent', markerId, weaponName, componentName)
...
local function openTints(markerId, weaponName)
    ESX.TriggerServerCallback('wcuk_job_creator:openTints', function(tints) 
        ...
        function(data, menu)
            ...
            TriggerServerEvent('wcuk_job_creator:buyWeaponTint', markerId, weaponName, tintId)
...
function openOwnedWeapons(markerId)
    ...
    ESX.TriggerServerCallback('wcuk_job_creator:getOwnedWeapons', function(weapons)
        local elements = {}
