function openCraftingTable(markerId)
    ESX.TriggerServerCallback('wcuk_job_creator:getCraftingTableData', function(craftingTableData) 
        ...
        function(data, menu)
            ...
            function(data, menu)
                if(data.current.type == "slider") then
                    ...
                    TriggerServerEvent('wcuk_job_creator:craftItem', markerId, itemName, craftAmount)
                end
            end,
            function(data, menu)
                openedMenu = nil
    ...
    while isCrafting do
        ...
        if(not hasStopped) then
            ...
            if(IsControlJustReleased(0, 38)) then
                TriggerServerEvent('wcuk_job_creator:stopCrafting')
...
RegisterNetEvent('wcuk_job_creator:crafting_table:startCrafting', startCrafting)