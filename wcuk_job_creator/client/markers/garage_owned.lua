local function openPlayerVehicles(markerId)
    ESX.TriggerServerCallback('wcuk_job_creator:garage_owned:getVehicles', function(vehicles, spawnData)
        ...
        function(data, menu)
            ...
            ESX.Game.SpawnVehicle(vehicleName, coords, spawnData.heading, function(vehicle)
                TriggerServerEvent('wcuk_job_creator:garage_owned:spawnedVehicle', vehiclePlate)
    ...
    function(data, menu)
        ...
        elseif(action == "deposit") then
            ...
            if(DoesEntityExist(vehicle)) then
                ...
                ESX.TriggerServerCallback('wcuk_job_creator:garage_owned:updateVehicleProps', function(isSuccessful) 
