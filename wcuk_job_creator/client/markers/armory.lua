local function depositWeaponInArmory(markerId)
    ESX.TriggerServerCallback('wcuk_job_creator:getPlayerWeapons', function(weapons) 
        local elements = {}
        ...
        function(data, menu)
            ...
            if(weaponName ~= "invalid") then
                ESX.TriggerServerCallback('wcuk_job_creator:depositWeaponInArmory', function(isSuccessful) 
...
local function takeWeaponFromArmory(markerId)
    ESX.TriggerServerCallback('wcuk_job_creator:retrieveArmoryWeapons', function(weapons) 
        local elements = {}
        ...
        function(data, menu)
            ...
            ESX.TriggerServerCallback('wcuk_job_creator:takeWeaponFromArmory', function(isSuccessful)
                if(isSuccessful) then
