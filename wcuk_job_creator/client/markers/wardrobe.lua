local function openPlayerOutfits()
    ESX.TriggerServerCallback('wcuk_job_creator:getPlayerWardrobe', function(outfits)
        local elements = {}
    ...
    ESX.TriggerServerCallback('wcuk_job_creator:getPlayerWardrobe', function(outfits)
        ...
        ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'remove_cloth', {
            ...
            if(outfitID) then
                ...
                TriggerServerEvent('wcuk_job_creator:wardrobe:deleteOutfit', data.current.id)
            ...
            ESX.UI.Menu.Open('dialog', GetCurrentResourceName(), 'outfit_name', {
                ...
                if(outfitLabel) then
                    TriggerEvent('skinchanger:getSkin', function(skin)
                        TriggerServerEvent('wcuk_job_creator:saveNewOutfitInWardrobe', skin, outfitLabel)
                    end)
