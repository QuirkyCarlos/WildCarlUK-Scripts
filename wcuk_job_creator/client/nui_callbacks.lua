...
RegisterNUICallback("refresh-jobs", function(data, cb)    
    TriggerServerEvent('wcuk_job_creator:refresh_esx_jobs')
end)
...
RegisterNUICallback("create-new-rank", function(data, cb)
    ...
    ESX.TriggerServerCallback('wcuk_job_creator:createRank', function(data)
        cb(data)
    end, jobName, rankName, rankLabel, rankGrade, rankSalary)
end)

RegisterNUICallback("update-rank", function(data, cb)
    ESX.TriggerServerCallback('wcuk_job_creator:updateRank', function(data)
        cb(data)
    end, data)
end)
...
RegisterNUICallback("delete-rank", function(data, cb)
    ...
    ESX.TriggerServerCallback('wcuk_job_creator:deleteRank', function(data)
        cb(data)
    end, rankId)
end)
...
RegisterNUICallback("retrieve-job-ranks", function(data, cb)
    local jobName = data.jobName
    ESX.TriggerServerCallback('wcuk_job_creator:retrieveJobRanks', function(ranks)
        cb(ranks)
    end, jobName)
end)
...
RegisterNUICallback("create-new-job", function(data, cb)
    if(data) then
        ESX.TriggerServerCallback('wcuk_job_creator:createNewJob', function(data)
            cb(data)
...
RegisterNUICallback("update-job", function(data, cb)
    ...
    ESX.TriggerServerCallback('wcuk_job_creator:updateJob', function(data)
        cb(data)
...
RegisterNUICallback("delete-job", function(data, cb)
    ...
    if(jobName) then
        ESX.TriggerServerCallback('wcuk_job_creator:deleteJob', function(data)
            cb(data)
        end, jobName)
    end
end)
...
RegisterNUICallback("get-jobs-data", function(data, cb)
    ESX.TriggerServerCallback('wcuk_job_creator:getJobsData', function(jobsData)
        cb(jobsData)
    end)
end)
...
RegisterNUICallback("retrieve-job-markers", function(data, cb)
    ...
    if(jobName) then
        ESX.TriggerServerCallback('wcuk_job_creator:getMarkersFromJobName', function(markers)
...
RegisterNUICallback("create-marker", function(data, cb)
    if(data) then
        ...
        ESX.TriggerServerCallback('wcuk_job_creator:createMarker', function(data)
            cb(data)
...
RegisterNUICallback("update-marker", function(data, cb)
    if(data) then
        ...
        ESX.TriggerServerCallback('wcuk_job_creator:updateMarker', function(data)
            cb(data)
        end, markerId, data)
    end
end)
...
RegisterNUICallback("update-marker-data", function(data, cb)    
    ...
    ESX.TriggerServerCallback('wcuk_job_creator:updateMarkerData', function(data)
        cb(data)
...
RegisterNUICallback("delete-marker", function(data, cb)
    local markerId = data.markerId
    ESX.TriggerServerCallback('wcuk_job_creator:deleteMarker', function(data)
        cb(data)
    end, markerId)
end)
...
RegisterNUICallback("delete-stash-inventory", function(data, cb)    
    ...
    ESX.TriggerServerCallback('wcuk_job_creator:deleteStashInventory', function(data)
        cb(data)
    end, markerId)
end)
...
RegisterNUICallback('delete-armory-inventory', function(data, cb)
    ...
    ESX.TriggerServerCallback('wcuk_job_creator:deleteArmoryInventory', function(data)
        cb(data)
    end, markerId)
end)
