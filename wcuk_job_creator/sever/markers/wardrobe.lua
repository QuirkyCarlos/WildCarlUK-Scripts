...
RegisterNetEvent('wcuk_job_creator:saveNewOutfitInWardrobe')
AddEventHandler('wcuk_job_creator:saveNewOutfitInWardrobe', function(outfit, outfitLabel)
...
RegisterNetEvent('wcuk_job_creator:wardrobe:deleteOutfit')
AddEventHandler('wcuk_job_creator:wardrobe:deleteOutfit', function(outfitId)
    local playerId = source
    local xPlayer = ESX.GetPlayerFromId(playerId)
    local identifier = xPlayer.identifier
