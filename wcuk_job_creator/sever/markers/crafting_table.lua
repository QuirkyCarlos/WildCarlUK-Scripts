...
RegisterNetEvent('wcuk_job_creator:craftItem')
AddEventHandler('wcuk_job_creator:craftItem', function(markerId, itemName, craftAmount)
            ...
            if (recipe) then
                ...
                for i = 1, craftAmount do
                    ...
                    if (hasAllItem(playerId, recipe)) then
                        ...
                        TriggerClientEvent('wcuk_job_creator:crafting_table:startCrafting', playerId, craftingTime, getLocalizedText('crafting', itemLabel))
...
RegisterNetEvent('wcuk_job_creator:stopCrafting')
AddEventHandler('wcuk_job_creator:stopCrafting', function()
    local playerId = source
    playerCraftingItems[playerId] = false
end)
