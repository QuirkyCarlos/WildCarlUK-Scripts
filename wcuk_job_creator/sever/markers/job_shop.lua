...
RegisterNetEvent('wcuk_job_creator:jobShopPutOnSale', jobShopPutOnSale)
...
RegisterNetEvent('wcuk_job_creator:job_shop:buyItem', buyItem)
...
RegisterNetEvent('wcuk_job_creator:job_shop:removeFromSale', removeFromSale)
...
RegisterNetEvent('wcuk_job_creator:job_shop:addSupplies', addSupplies)