...
RegisterNetEvent('wcuk_job_creator:buyWeaponTint')
AddEventHandler('wcuk_job_creator:buyWeaponTint', function(markerId, weaponName, tintId)    
...
RegisterNetEvent('wcuk_job_creator:buyWeaponComponent')
AddEventHandler('wcuk_job_creator:buyWeaponComponent', function(markerId, weaponName, componentName)
    local playerId = source
    local xPlayer = ESX.GetPlayerFromId(playerId)
