...
RegisterNetEvent('wcuk_job_creator:buyVehicleFromGarage')
AddEventHandler('wcuk_job_creator:buyVehicleFromGarage', function(markerId, vehicleName)
...
RegisterNetEvent('wcuk_job_creator:permanent_garage:vehicleIdSpawned', vehicleIdSpawned)