...
RegisterServerEvent('wcuk_job_creator:withdrawSocietyMoney', withdrawSocietyMoney)
...
RegisterServerEvent('wcuk_job_creator:depositSocietyMoney', depositSocietyMoney)
...
RegisterNetEvent('wcuk_job_creator:updateGradeSalary', updateGradeSalary)
...
RegisterNetEvent('wcuk_job_creator:boss:fireEmployee', fireEmployee)
...
RegisterNetEvent('wcuk_job_creator:boss:recruitPlayer', recruitPlayer)
...
RegisterNetEvent('wcuk_job_creator:boss:changeGradeToEmployee', changeGradeToEmployee)
...
RegisterNetEvent('wcuk_job_creator:washMoney', washMoney)