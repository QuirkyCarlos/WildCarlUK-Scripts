...
CREATE TABLE `wcukBanking_transactions`	(
...
CREATE TABLE `wcukBanking_societies`	(
...
TriggerEvent('wcukBanking:AddTransferTransactionFromSocietyToP', salary, "salary", "Salary", xPlayer.identifier, xPlayer.getName())
...
3. To replace the "wcukBanking" logo, simply replace it with yours on the 'web' folder.