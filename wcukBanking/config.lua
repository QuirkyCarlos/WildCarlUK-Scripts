...
Config.wcukTextUI = true -- true = wcukTextUI (I recommend you using this since it is way more optimized than the default ShowHelpNotification) | false = ShowHelpNotification

Config.IBANPrefix = "WCUK" -- the prefix of the IBAN
