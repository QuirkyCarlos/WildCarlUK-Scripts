...
RegisterNetEvent('WCUK_DopePlant:RemovePlant')
...
function MFD:SyncPlant(plant,delete)
  ...
  TriggerClientEvent('WCUK_DopePlant:SyncPlant',-1,plant,delete)
end
...
ESX.RegisterServerCallback('WCUK_DopePlant:GetLoginData', function(source,cb) cb(MFD:GetLoginData(source)); end)
ESX.RegisterServerCallback('WCUK_DopePlant:GetStartData', function(source,cb) while not MFD.dS do Citizen.Wait(0); end; cb(MFD.cS); end)
AddEventHandler('WCUK_DopePlant:SyncPlant', function(plant,delete) MFD:SyncPlant(plant,delete); end)
...
ESX.RegisterUsableItem('wateringcan', function(source)
  ...
  if xPlayer.getInventoryItem('wateringcan').count > 0 then 
    ...
    TriggerClientEvent('WCUK_DopePlant:UseItem',source,template)
  end
end)
...
ESX.RegisterUsableItem('lowgrademaleseed', function(source)
  ...
  if xPlayer.getInventoryItem('lowgrademaleseed').count > 0 and xPlayer.getInventoryItem('plantpot').count > 0 then 
    ...
    TriggerClientEvent('WCUK_DopePlant:UseSeed',source,template)
  end
end)
...
ESX.RegisterUsableItem('dopebag', function(source)
  ...
  TriggerClientEvent('WCUK_DopePlant:UseBag', source, canUse, msg)
end)
