...
RegisterNetEvent('WCUK_DopePlant:SyncPlant')
RegisterNetEvent('WCUK_DopePlant:UseSeed')
RegisterNetEvent('WCUK_DopePlant:UseItem')
RegisterNetEvent('WCUK_DopePlant:UseBag')
RegisterNetEvent('WCUK_DopePlant:UseRollingPapers')

local MFD = WCUK_DopePlant

function MFD:Start()
  self.Plants = {}
  self.timer = GetGameTimer()
  ESX.TriggerServerCallback('WCUK_DopePlant:GetLoginData', function(plants)  
...
function MFD:Awake(...)
    ...
    ESX.TriggerServerCallback('WCUK_DopePlant:GetStartData', function(retVal) self.dS = true; self.cS = retVal; end)
...
function MFD:Sync(plant,delete)
  TriggerServerEvent('WCUK_DopePlant:SyncPlant',plant,delete)
end
...
AddEventHandler('WCUK_DopePlant:UseSeed', function(seed) if MFD.iR then MFD:UseSeed(seed); end; end)
AddEventHandler('WCUK_DopePlant:UseItem', function(item) if MFD.iR then MFD:UseItem(item); end; end)
AddEventHandler('WCUK_DopePlant:SyncPlant', function(plant,del) if MFD.iR then MFD:SyncHandler(plant,del); end; end)
AddEventHandler('WCUK_DopePlant:UseBag', function(canUse,msg) MFD:UseBag(canUse,msg); end)
